<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="huizhi_shbzkst.aspx.cs" Inherits="XF_Web_Concise.huizhi_shbzkst" %>
...
<body>
    ...
    <%--<img src="images/hzsy.gif" id="dt" alt="" />--%>
        <div id="mainbox" style="height:437px;">
            <div id="header">
                <h1>
                    <span>
            ...
            <div id="content" style="height:377px;">  
            <p style="text-indent:24px">____________先生 / 女士 身份证号码：________________________</p>
                    <p style="text-indent:24px;">您的相片符合《社会保障卡数字相片技术要求》，请持此回执和申请材料及时到当地社保管理部门申办（本回执及数字相片半年内有效）。</p>
                    <div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="huizhi_bay.aspx.cs" Inherits="XF_Web_Concise.huizhi_bay" %>
    ...
    <%--<img src="images/hzsy.gif" id="dt" alt="" />--%>
        <div id="mainbox">
            <div id="header">
                <h1>
                    <span>
                        </span>广 东 省 保 安 员 证 数 字 相 片 采 集 回 执</h1>
                        <h3>
            ...
            <div id="content">  
                    <p style="text-indent:24px;">您的相片符合《广东省保安员证数字相片技术要求》，请持此回执及申请材料尽快到当地办证部门申办（本回执及数字相片30天内有效）。</p>
                    <div>

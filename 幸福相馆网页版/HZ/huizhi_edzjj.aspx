<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="huizhi_edzjj.aspx.cs" Inherits="XF_Web_Concise.huizhi_edzjj" %>
...
<body>
   ...
   <%-- <img src="images/hzsy.gif" id="dt" alt="" />--%>
        <div id="mainbox">
            ...
            <div id="content">  
            <p style="text-indent:24px">____________先生 / 女士 原身份证号码：________________________
...
<p>采集之日起60天内，您可以登录“我的幸福相馆”客户端免费补打本回执，详情请登录<a href="#open=wbhttp://bzztc.gdbnet.cn/xfxg/"  target="_self">http://bzztc.gdbnet.cn/xfxg/</a>进行了解。</p>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="huizhi_jzz.aspx.cs" Inherits="XF_Web_Concise.huizhi_jzz" %>
    ...
    <%--<img src="images/hzsy.gif" id="dt" alt="" />--%>
        <div id="mainbox">
            <div id="header">
                <h1>
                    <span>
                        </span>广 东 省 居 住 证 数 字 相 片 采 集 回 执</h1>
                        <h3>
            ...
            <div id="content">  
                    <p style="text-indent:24px;">您的相片符合《广东省居住证制证用数字相片技术要求》，请持此回执及申请材料尽快到居住地公安派出所或乡镇、街道流动人口服务管理机构申办（本回执及数字相片30天内有效）。</p>
                    <div>
...
<p>采集之日起30天内，您可以登录“我的幸福相馆”客户端免费补打本回执，详情请登录<a href="http://bzztc.gdbnet.cn/xfxg/"  target="_blank">http://bzztc.gdbnet.cn/xfxg/</a>进行了解。</p>

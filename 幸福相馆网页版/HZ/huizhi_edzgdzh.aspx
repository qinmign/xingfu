<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="huizhi_edzgdzh.aspx.cs" Inherits="XF_Web_Concise.huizhi_edzgdzh" %>
...
并且相片为我本人      <br /><br />
    ...
    <%--<img src="images/hzsy.gif" id="dt" alt="" />--%>
        <div id="mainbox">
            ...
            <p style="text-indent:24px;">您的相片符合《社会保障卡数字相片技术要求》，请持此回执和申请材料及时到当地社保管理部门申办，社保咨询电话：0756-12333（本回执及数字相片60天内有效）。</p>
            <div>
            <p style="display:none;">*1</p>
            <p class="tmz">*<% =pid %>*</p>
            </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/XF.Master" AutoEventWireup="true" CodeBehind="confirmorder.aspx.cs" Inherits="XF_Web_Concise.confirmorder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        var shoppingcarSign = "";
        var currentPage = "confirmorder.aspx";
...
<asp:Content ID="Content3" ContentPlaceHolderID="mBody" runat="server">
    <div class="content">
        ...
        <div class="wormtip" style="height:55px;width:998px;">

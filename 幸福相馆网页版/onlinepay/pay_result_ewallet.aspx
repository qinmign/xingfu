<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pay_result_ewallet.aspx.cs" Inherits="XF_Web_Concise.pay_result_ewallet" %>
...
<body>
    ...
    <div id="content">
        <div class="<% =jg %>" id="result">
            ...
            <p>订单号：<% =orderno %><br />金额：<% =fee %>元<br /><% =msg %></p>
